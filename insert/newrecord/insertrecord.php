...
<body>
    ...
    <form action="/" method="POST" enctype="multipart/form-data">
      <div class="form-group mb-3">
        <label for="districtcol" class="form-label"> <h1>District</h1></label>
          ...
          <label for="marketname" class="form-label"> <h1>Market Name</h1></label><br>
          <div class="input-group mb-3 form-group">
            ...
            <br>
            <label for="address" class="form-label"> <h1>Address</h1></label><br>
            <div class="input-group mb-3 form-group">
              <div class="input-group">
          ...
          <label for="tel1" class="form-label"><h1>Telephone 1</h1></label><br>
          <div class="input-group mb-3 form-group">
          ...
          <label for="tel2" class="form-label"><h1>Telephone 2</h1></label><br>
            <div class="input-group mb-3 form-group">
              <div class="input-group-prepend"><span class="input-group-text">+852</span>
              </div>
          ...
          <label for="Map" class="form-label"><h1>Map Location</h1></label>
          <br>
      </div>
